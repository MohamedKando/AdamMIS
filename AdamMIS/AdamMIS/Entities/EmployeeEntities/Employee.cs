...
namespace AdamMIS.Entities.EmployeeEntities
{
    public class Employee
    {
        ...
        public string? DepartmentName { get; set; } // Add this if it doesn't exist
        public Department Department { get; set; } = null!;

        // Employee Type
        public bool IsMedical { get; set; }

        // Medical Fields (Department Head Step - only if IsMedical = true)
        ...
        // System Permissions (Department Head Step)
        public string? SystemPermissions { get; set; }

        // IT Access (IT Head Step)
        ...
        // Workflow Status
        public string CurrentStep { get; set; } = "HR"; // "HR", "DepartmentHead", "IT", "CEO", "Completed"
        public string Status { get; set; } = "Draft"; // "Draft", "InProgress", "Approved"

        // Step Completion Tracking (simplified approval tracking)
