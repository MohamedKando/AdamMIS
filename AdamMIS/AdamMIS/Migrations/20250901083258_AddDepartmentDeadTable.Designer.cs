...
namespace AdamMIS.Migrations
{
    ...
    [Migration("20250901083258_AddDepartmentDeadTable")]
    partial class AddDepartmentDeadTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AdamMIS.Entities.DepartmentEntities.Department", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AdamMIS.Entities.DepartmentEntities.DepartmentHead", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AdamMIS.Entities.UserEntities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEHrxE0rGEdO0HsJ+mGW1zNVVjE/EZhSi0MJ57NSgGGMllxXmidtiXZ1JiRFjXfHsKA==",
            ...
            modelBuilder.Entity("AdamMIS.Entities.DepartmentEntities.DepartmentHead", b =>
                {
                    b.HasOne("AdamMIS.Entities.DepartmentEntities.Department", "Department")
                        .WithMany("Heads")
