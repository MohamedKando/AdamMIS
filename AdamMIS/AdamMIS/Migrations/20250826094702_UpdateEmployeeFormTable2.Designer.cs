...
namespace AdamMIS.Migrations
{
    ...
    [Migration("20250826094702_UpdateEmployeeFormTable2")]
    partial class UpdateEmployeeFormTable2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AdamMIS.Entities.UserEntities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEFJjRbZEXPZEValXhOFI8q2on3I2C72VMGIsYTecOiy95dN34wnJabsVwbeKBNgClg==",
            ...
            modelBuilder.Entity("AdamMIS.Entities.EmployeeEntities.Employee", b =>
                {
                    ...
                    b.HasOne("AdamMIS.Entities.UserEntities.ApplicationUser", "CreatedBy")
                        .WithMany()
